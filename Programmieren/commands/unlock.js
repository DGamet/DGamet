...
module.exports = {
  ...
  execute(client, message, args){
    ...
    channel.permissionOverwrites.edit(`${role.id}`, {
      ...
      if(errr === 0) channel.send({embeds: [new MessageEmbed().setDescription(`${y} ${message.author} hat diesen Kanal für die Rolle <@&${role.id}> mit der Begründung **${grund}** entsperrt.`)]})
    })
  }
}